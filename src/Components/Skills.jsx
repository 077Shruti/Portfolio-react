    ...
    <Parallax speed={-10}>
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-4 sm:gap-6 mt-6">
          ...
          >
            <img className="w-12 h-12 sm:w-16 sm:h-16 object-contain" src="java (1).png" alt="Java" />
          </div>
          ...
          >
            <img className="w-12 h-12 sm:w-16 sm:h-16 object-contain" src="js (1).png" alt="JavaScript" />
          </div>
          ...
          >
            <img className="w-12 h-12 sm:w-16 sm:h-16 object-contain" src="react.png" alt="React" />
          </div>
          ...
          >
            <img className="w-12 h-12 sm:w-16 sm:h-16 object-contain" src="html.png" alt="HTML" />
          </div>
          ...
          >
            <img className="w-12 h-12 sm:w-16 sm:h-16 object-contain" src="css-3.png" alt="CSS" />
          </div>
          ...
          >
            <img className="w-12 h-12 sm:w-16 sm:h-16 object-contain" src="sql-server.png" alt="SQL Server" />
          </div>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-6 mb-9 ">
          ...
          >
            <img className="w-12 h-12 sm:w-16 sm:h-16 object-contain" src="nodejs.png" alt="Node.js" />
          </div>
          ...
          >
            <img className="w-12 h-12 sm:w-16 sm:h-16 object-contain" src="mongo-removebg-preview.png" alt="MongoDB" />
          </div>
          ...
          >
            <img className="w-12 h-12 sm:w-16 sm:h-16 object-contain" src="github.png" alt="GitHub" />
          </div>
          ...
          >
            <img className="w-12 h-12 sm:w-16 sm:h-16 object-contain" src="logo.png" alt="Logo" />
          </div>
          ...
          >
            <img className="w-12 h-12 sm:w-16 sm:h-16 object-contain" src="Jupyter_logo.svg.png" alt="Jupyter" />
          </div>
          ...
          >
            <img className="w-12 h-12 sm:w-16 sm:h-16 object-contain" src="python.png" alt="Python" />
          </div>
        </div>
